...
namespace WebApi2Book.Web.Api.Tests.InquiryProcessing
{
    ...
    public class PagedDataRequestFactoryTest
    {
        ...
        {
            var requestMessage = HttpRequestMessageFactory
                .CreateRequestMessage(HttpMethod.Get,"http://www.foo.com/bar?pageNumber=2&pageSize=10&pageNumber=50");
            try
            {
        ...
        public void Create_uses_corrected_supplied_pageNumber()
        {
            ...
            var requestMessage = HttpRequestMessageFactory
                .CreateRequestMessage(HttpMethod.Get, $"http://www.foo.com/bar?pageNumber={pageNumber}");
        ...
        public void Create_uses_corrected_supplied_pageSize()
        {
            ...
            var requestMessage = HttpRequestMessageFactory
                .CreateRequestMessage(HttpMethod.Get, $"http://www.foo.com/bar?pageSize={pageSize}");
            var inquiryRequestData = _requestFactory.Create(requestMessage.RequestUri);
