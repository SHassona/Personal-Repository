...
namespace WebApi2Book.Web.Api.Tests.InquiryProcessing
{
    ...
    public class AllTasksInquiryProcessorTest
    {
        ...
        private class AllTasksInquiryProcessorTestDouble : AllTasksInquiryProcessor
        {
            ...
            public Func<IEnumerable<Task>, IEnumerable<Models.Task>> GetTasksTestDouble { private get; set; }

            public Action<PagedTaskDataInquiryResponse>
                AddLinksToInquiryResponseTestDouble
            { private get; set; }

            public Func<PagedTaskDataInquiryResponse, string> GetCurrentPageQueryStringTestDouble { private get; set; }
            public Func<PagedTaskDataInquiryResponse, string> GetNextPageQueryStringTestDouble { private get; set; }
            public Func<PagedTaskDataInquiryResponse, string> GetPreviousPageQueryStringTestDouble { private get; set; }
