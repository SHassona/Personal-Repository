...
namespace WebApi2Book.Web.Api.Tests.Controllers.V1
{
    public class TasksControllerDependencyBlockMock : Mock<ITasksControllerDependencyBlock>
    {
        ...
        public TasksControllerDependencyBlockMock()
        {
            ...
            Setup(x => x.TaskByIdInquiryProcessor)
                .Returns(TaskByIdInquiryProcessorMock.Object);
            Setup(x => x.UpdateTaskMaintenanceProcessor)
                .Returns(UpdateTaskMaintenanceProcessorMock.Object);
            Setup(x => x.PagedDataRequestFactory)
                .Returns(PagedDataRequestFactoryMock.Object);
            Setup(x => x.AllTasksInquiryProcessor)
                .Returns(AllTasksInquiryProcessorMock.Object);
        }
