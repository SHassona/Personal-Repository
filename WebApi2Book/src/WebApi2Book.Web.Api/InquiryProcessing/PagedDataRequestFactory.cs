    ...
    public class PagedDataRequestFactory : IPagedDataRequestFactory
    {
        ...
        public PagedDataRequest Create(Uri requestUri)
        {
            ...
            try
            {
                ...
                pageNumber = PrimitiveTypeParser
                    .Parse<int?>(valueCollection[Constants.CommonParameterNames.PageNumber]);
                pageSize = PrimitiveTypeParser
                    .Parse<int?>(valueCollection[Constants.CommonParameterNames.PageSize]);
            }
            catch (Exception e)
            {
            ...
            pageSize = pageSize.GetBoundedValue(DefaultPageSize, Constants.Paging.MinPageSize,
                MaxPageSize);
